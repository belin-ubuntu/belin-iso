...
rm -r workdir;sync;python3 scrypts/cdmanufacture -a amd64 -c /mnt2/focal/mate/chroot -C /mnt2/focal/mate/cdstructure -e /mnt2/focal/mate/extra_commands.txt -i /mnt2/focal/mate/packages-install.txt -r /mnt2/focal/mate/packages-remove.txt -l "BeLin-7.0-mate" /media/virtual/focal_mate.iso;sync
